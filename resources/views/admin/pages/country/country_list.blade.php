            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a class="btn btn-add btn-sm" href="{{ route('admin.country_create') }}" title="Create"><i
                                    class="fas fa-plus"></i>
                                Create Country</a>
                        </div>
                    </div>
                            ...
                            @foreach ($Country as $item)
                                <tr>
                                    ...
                                    <td class="table-td-center">
                                        <a href="{{ route('admin.country_edit', $item->id) }}" type="submit"
                                            class="btn btn-success">Sửa</a>
                                        <a href="{{ route('admin.country_delete', $item->id) }}" type="submit"
